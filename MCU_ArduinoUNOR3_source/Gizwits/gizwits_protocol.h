...
* @{
*/
#define PRODUCT_KEY "208ca6e0bcdd45049b25106c65890dd0"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "57d6261551234fada86f8c8e11a6368b"
...
#define hum_RATIO                         1
#define hum_ADDITION                      0
#define hum_MIN                           0
#define hum_MAX                           100
#define temprature_RATIO                         0.01
#define temprature_ADDITION                      -300
#define temprature_MIN                           0
#define temprature_MAX                           45000
#define soil_h_RATIO                         1
#define soil_h_ADDITION                      -100
#define soil_h_MIN                           0
#define soil_h_MAX                           2100
#define sunlight_RATIO                         1
#define sunlight_ADDITION                      -100
#define sunlight_MIN                           0
#define sunlight_MAX                           2100
/**@} */
...
typedef struct {
  uint32_t valuehum;
  float valuetemprature;
  int32_t valuesoil_h;
  int32_t valuesunlight;
} dataPoint_t;
...
typedef struct {
  uint8_t valuehum;
  uint16_t valuetemprature;
  uint16_t valuesoil_h;
  uint16_t valuesunlight;
} devStatus_t; 
