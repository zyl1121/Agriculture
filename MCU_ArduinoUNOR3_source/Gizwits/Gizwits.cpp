...
void Gizwits::write(VALUE_TYPE_T valueType, uint32_t value)
{
	...
	{
		case VALUE_hum:
			currentDataPoint.valuehum = value;
		break;
		case VALUE_temprature:
			currentDataPoint.valuetemprature = value;
		break;
		case VALUE_soil_h:
			currentDataPoint.valuesoil_h = value;
		break;
		case VALUE_sunlight:
			currentDataPoint.valuesunlight = value;
		break;
		default:
			break;
	}
